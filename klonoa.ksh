...
LIENSUTILES=('https://framalibre.org/annuaires/cr%C3%A9ation', 'https://www.openbsd.org/', 'https://www.3hg.fr/', 'https://morevnaproject.org/', 'https://9fans.github.io/plan9port/')
JPEGTURBO=''
SuperLU=''
